...
| 0.6 ✅ whole worm | **Minimal organism**: a C. elegans-scale developmental run from a real genome plus bootstrap state | `genomeos grow`: zygote → 959-cell adult, every cell, fate and death matching Sulston; timing within a median 12 min; mechanism for the founders, observed lineage program after (BioLang v0.3, Body runtime) |
