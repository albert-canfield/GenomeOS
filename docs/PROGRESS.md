...
- **Proteome chr22 compiled** (432 coding genes from the Ensembl gene list, 21 min): sequence 98.6%, function 86.6%, pathways 61.1%, interactions 84.3%, experimental structure 46.3%, expression 100%. The genome-wide proteome job continues smallest chromosome first.
