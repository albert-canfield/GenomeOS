...
| Ensembl REST variation endpoint | the independent check of every variant position written into the known-locus benchmark | Apache 2.0 service, EMBL-EBI terms |
